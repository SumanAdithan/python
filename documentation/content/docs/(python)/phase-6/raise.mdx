---
title: raise
description: Python's throw — with built-in exception types instead of a generic Error
---
...
## Built-in exception types instead of one generic Error
