...
description: Close the tutorial and build this yourself — the best prep for FastAPI
---
...
<details>
<summary>Solution — only open this after you've genuinely tried</summary>
