...
description: A real-world walkthrough that ties client, backend, database, and file storage together
---
...
## Why databases aren't built for this
...
## Walking through: uploading a video
...
## Walking through: watching a video
