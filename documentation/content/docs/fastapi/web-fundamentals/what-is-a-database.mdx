...
description: Where the backend keeps data that has to survive and stay organized
---
...
## Why not just store data in a variable?
...
## The kind of database you'll use in this course
